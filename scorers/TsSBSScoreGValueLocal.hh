...
#ifndef TsSBSScoreGValueLocal_hh
#define TsSBSScoreGValueLocal_hh
...
class TsSBSScoreGValueLocal : public TsVNtupleScorer
{
public:
	TsSBSScoreGValueLocal(TsParameterManager* pM, TsMaterialManager* mM, TsGeometryManager* gM, TsScoringManager* scM, TsExtensionManager* eM,
						  G4String scorerName, G4String quantity, G4String outFileName, G4bool isSubScorer);
	~TsSBSScoreGValueLocal();
